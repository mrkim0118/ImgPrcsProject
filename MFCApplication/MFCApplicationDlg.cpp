...
void CMFCApplicationDlg::OnContextMenu(CWnd* pWnd, CPoint point)
{
	CMenu popup;
	CMenu* pMenu;

	popup.LoadMenuW(IDR_MENU);
...
CDlg_ImgPrcs * CMFCApplicationDlg::getDlg_ImgPrcsPtr()
{
	return m_pDlg_ImgPrcs;
}

CEtc * CMFCApplicationDlg::getEtcPtr()
{
	return m_pEtc;
}
